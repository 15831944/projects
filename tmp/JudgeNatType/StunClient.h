...
public:
	...
	bool Start(unsigned long Task_id, std::string localIP, unsigned short localPort, std::string stunServerIP, unsigned short stunServerPort1, unsigned short stunServerPort2);
